...
public class DatabaseConnection {
    ...
    public void updateQuantity(int quantity, int id) throws SQLException {
        ...
        // If connection is established
        if (connection != null) {
            // To update the quantity for item purchased
    ...
    public void RemoveItem(int id) throws SQLException {
        ...
        if (connection != null) {
            ...
            String query2 = "DELETE FROM cart WHERE itemID="+id;
            try {
                stmt = connection.createStatement();
                stmt.executeUpdate(query);
    ...
    public ResultSet displayCart(String username) throws SQLException{
        ...
        // If connection is established
        if (connection != null) {
            // To get item details for the cart
    ...
    // To update the cart after purchase
