...
public class AdminFactory implements UserPage{
	...
	public int displaySelectedItem(String[] item){
		...
		System.out.println("---------------------------------------");
		System.out.println("Menu:");
		System.out.println("1) Purchase Selected Item");
		System.out.println("2) Update Selected Item");
		System.out.println("3) Remove Selected Item");
		System.out.println("4) Add selected Item to Cart");
		System.out.println("5) Browse Items");
